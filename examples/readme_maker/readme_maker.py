...
input_repo_readme = input(
    "Enter the GitHub repository (in the format owner/repo-name) to use its README as a template: "
)
target_repo = input(
...
prompt = (
    f"Create a new README file for the repository {target_repo} using the README "
